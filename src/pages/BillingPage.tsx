    ...
    return (
      <div className="overflow-hidden flex-col gap-y-4 bg-Siuu w-screen min-h-screen flex items-center ">
        <div className="w-10/12 h-[70px] mt-[44px] flex justify-end items-center gap-x-3">
          <button
            className="px-4 py-2 text-[24px] max-h-[50px] border border-black rounded-md"
            onClick={connectWallet}
          >
            {account ? (
              <div>{account.slice(0, 4) + '...' + account.slice(-4)}</div>
            ) : (
        ...
        <div className="w-10/12 mt-[20px] flex gap-x-3 flex-col justify-center gap-y-6">
          <h3 className="uppercase text-[54px] w-full flex items-center font-bold">
            Billing
          </h3>
          <div className="w-full justify-between flex gap-x-10">
            ...
            <div className="rounded-md flex flex-col w-6/12 bg-white p-10 justify-between items-center shadow-lg shadow-black">
              <h3 className="uppercase font-bold text-[36px]">
                Checkout Details
              </h3>
              <div className="w-8/12 flex flex-col items-center border-b border-black pb-3 ">
                <div className="flex justify-between w-full items-center text-[24px] font-semibold">
                  No. Of Tickets :{' '}
                  <div className="flex gap-x-3">
                    <div
                      className="border border-black rounded-full h-10 w-10 flex justify-center items-center"
                ...
                <div className="flex justify-between w-full items-center text-[24px] font-semibold">
                  Price : <span>{(item['Price'] * tickets).toFixed(2)}</span>
                </div>
                <div className="flex justify-between w-full items-center text-[24px] font-semibold">
                  Currency : <span>ETH</span>
                </div>
                <div className="flex justify-between w-full items-center text-[24px] font-semibold">
                  NFT Preview :{' '}
                  <img
        ...
        <div className="flex mt-[38px] justify-center w-10/12">
          <h1 className="uppercase font-bold text-[48px]">
            Get yourself a NFT, Buy ticket now !!
          </h1>
        </div>
      </div>
    )
