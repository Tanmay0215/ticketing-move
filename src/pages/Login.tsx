    ...
    <div className="overflow-hidden bg-Siuu w-screen h-screen flex justify-center items-center">
      ...
      <div className="w-1/2">
        <div className="flex flex-col items-center">
          ...
          <form className="w-60 flex flex-col gap-y-10 mt-10">
            <div className="flex flex-col">
              ...
              <input
                ...
                id="email"
                className="h-9 border-2 rounded-lg p-2"
              ></input>
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex justify-center items-center h-12 bg-[#0E64D2] rounded-md cursor-pointer">
              <button onClick={submitHandler} className="text-xl">
                Login
              </button>
            </div>
          </form>
          ...
          <div
            className="flex justify-between items-center border-black border-2 border-opacity-60 py-1 px-3 rounded-md mt-4 gap-x-3 w-64 cursor-pointer"
            onClick={() => {
              handleLogin()
            }}
          >
