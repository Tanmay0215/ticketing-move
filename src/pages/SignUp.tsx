    ...
    <div className="overflow-hidden bg-Siuu w-screen h-screen flex justify-center items-center">
      ...
      <div className="w-1/2">
        <div className="flex flex-col items-center">
          ...
          <div
            className="flex justify-between items-center border-black border-2 border-opacity-60 py-1 px-3 rounded-md mt-4 gap-x-3 w-64 cursor-pointer font-poppins"
            onClick={() => {
              handleSignup()
            }}
          >
