...
const payment2 = () => {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-[#1F1F1F] text-white relative">
      <img
      ...
      <div className="flex flex-col justify-center absolute z-[1] bg-none items-center w-full">
        ...
        <div className="w-11/12 flex items-center pt-3 justify-between">
          <span className="text-[45px] font-jaini" onClick={goHome}>
            Ticketing
          </span>
        ...
        {parseInt(id.toString()[1]) === 0 ? (
          <div className="text-5xl text-[#cc0000] text-center font-semibold">
            Payment UnSuccess!!
          </div>
        ) : (
          <div className="text-5xl text-[#00CC30] text-center font-semibold">
            Payment Success!!
          </div>
        )}
                  ...
                  <div className="flex flex-col gap-y-4">
                    {ipfsArray.map((url, index) => (
                      <NavLink key={index} to={url}>
                        <button className="bg-green-500 text-black font-semibold text-2xl px-4 py-2 rounded-md">
                          view Nft metadata {index + 1}
                        </button>
                      </NavLink>
                    ))}
                  </div>
